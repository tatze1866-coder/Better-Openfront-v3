...
const dict = {
  ...
  statLosses: { de: 'Niederlagen', en: 'Losses' },
  statWinrate: { de: 'Siegquote', en: 'Win rate' },
  statGroupCombat: { de: 'Kampf & Überleben', en: 'Combat & Survival' },
  statGroupBuildings: { de: 'Bauwerke', en: 'Buildings' },
  statGroupActions: { de: 'Aktionen', en: 'Actions' },
  statGroupDiplomacy: { de: 'Diplomatie', en: 'Diplomacy' },
