...
const dict = {
  ...
  shBuildKeys: { de: '<b>1</b> Stadt · <b>2</b> Festung · <b>3</b> Hafen · <b>4</b> Fabrik · <b>5</b> Turm', en: '<b>1</b> City · <b>2</b> Fort · <b>3</b> Port · <b>4</b> Factory · <b>5</b> Tower' },
  shTowerAim: { de: 'Turm anklicken – Munition wählen, Ziel anklicken', en: 'Click a tower – choose ammo, click a target' },
  ...
  warshipSelectedOne: { de: 'Kriegsschiff ausgewählt – Ziel auf dem Wasser anklicken. ⛴', en: 'Warship selected – click a target on the water. ⛴' },
  warshipSelectedMany: { de: '{n} Kriegsschiffe ausgewählt – Ziel auf dem Wasser anklicken. ⛴', en: '{n} warships selected – click a target on the water. ⛴' },
  warshipEnRouteOne: { de: 'Kriegsschiff nimmt Kurs! ⛴', en: 'Warship setting course! ⛴' },
  warshipEnRouteMany: { de: '{n} Kriegsschiffe nehmen Kurs! ⛴', en: '{n} warships setting course! ⛴' },
  rectSelectNone: { de: 'Keine eigenen Kriegsschiffe oder Katapulte im Rechteck.', en: 'No own warships or catapults in the rectangle.' },
  stillUnderConstruction: { de: 'Noch im Aufbau.', en: 'Still under construction.' },

  // ---------- Turm (Munition, Panel, Meldungen) ----------
  ammoStone: { de: 'Stein', en: 'Stone' },
  ...
  // Munition im Ereignis-Feed (Dativ Plural: "mit …")
  ammoFeedStone: { de: 'Steinen', en: 'stones' },
  ammoFeedArrow: { de: 'Pfeilen', en: 'arrows' },
  ammoFeedFire: { de: 'Feuerpfeilen', en: 'fire arrows' },
  feedTowerShotYou: { de: '🏹 {name} beschießt dich mit {ammo} aus einem Turm!', en: '🏹 {name} is bombarding you with {ammo} from a tower!' },
  feedTowerHit: { de: '🎯 Turm trifft {name}!', en: '🎯 Tower hits {name}!' },
